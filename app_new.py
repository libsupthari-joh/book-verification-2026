...
# Admin மற்றும் DCL Staff-களுக்கு பொதுவான கடவுச்சொல், நூலகர்களுக்கு அவர்களின் ID-களின் அடிப்படையில் கடவுச்சொல் அமைக்கப்பட்டுள்ளது
USERS_DATABASE = {
    ...
    # நூலகர்களுக்கான மாதிரி ID மற்றும் கடவுச்சொற்கள் (இதனை உங்கள் தேவைக்கேற்ப மாற்றிக்கொள்ளலாம்)
    "TNDPL01617": {"password_hash": hash_password("123456789"), "name": "Chinthakampalli Librarian"},
    "TNDPL01586": {"password_hash": hash_password("123456789"), "name": "Pochampalli Librarian"},
}
    ...
    if submitted:
        if selected_role == "-- தேர்ந்தெடுக்கவும் --":
            ...
            if not user:
                ...
                st.session_state.update(logged_in=True, user_role=selected_role, user_name=display_name)
                st.rerun()
...
if current is None:
    ...
    edit_action_option = st.selectbox(
        "📌 எந்தப் பகுதியில் உள்ள தரவுகளை மாற்ற / நீ வேண்டும் என்பதைத் தேர்ந்தெடுக்கவும்:",
        [
