...
if str_lit.sidebar.button("🚪 வெளியேறு (Logout)", use_container_width=True):
    str_lit.session_state['logged_in'] = False
    str_lit.rerun()
...
if str_lit.sidebar.button("📥 1. பெறப்பட்ட நூல்கள் சரிபார்ப்பு", use_container_width=True):
    str_lit.session_state['current_page'] = "📥 1. பெறப்பட்ட நூல்கள் சரிபார்ப்பு"
    str_lit.rerun()
if str_lit.sidebar.button("🔄 2. Google Sheet தரவு ஒத்திசைவு (Sync)", use_container_width=True):
    str_lit.session_state['current_page'] = "🔄 2. Google Sheet தரவு ஒத்திசைவு (Sync)"
    str_lit.rerun()
if str_lit.sidebar.button("🏢 3. மொத்த பதிப்பாளர் விவரங்கள் (480)", use_container_width=True):
    str_lit.session_state['current_page'] = "🏢 3. மொத்த பதிப்பாளர் விவரங்கள் (480)"
    str_lit.rerun()
if str_lit.sidebar.button("🏛️ 4. நூலகத்திற்கு விநியோகம் (103)", use_container_width=True):
    str_lit.session_state['current_page'] = "🏛️ 4. நூலகத்திற்கு விநியோகம் (103)"
    str_lit.rerun()
if str_lit.sidebar.button("⚙️ 5. Accession எண்கள் மேலாண்மை", use_container_width=True):
